...
export const ShoppingCartFilledIcon = ({ className }: IconProps) => {
  return (
    <svg
      className={className}
...
export const StarHalfIcon = ({ className }: IconProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const CubeSendIcon = ({ className }: IconProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const ProgressAlertIcon = ({ className }: IconProps) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
